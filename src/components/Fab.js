...
import { faEnvelope, faFile, faL, fas  } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='floating-div right'>
        <div className='floating-icons'>
          <Tooltip title="Github" placement="left-start" arrow> 
            <a href="https://github.com/barathbalasubramanian/">
              <FontAwesomeIcon icon={faGithub}  
                style={{ color: hovered['github'] ? '#171515' : '' }} 
          ...
          <Tooltip title="Resume" placement="left-start" arrow> 
            <FontAwesomeIcon icon={faFile} onClick={openPdf} 
              style={{ color: hovered['resume'] ? 'green' : '' }} 
